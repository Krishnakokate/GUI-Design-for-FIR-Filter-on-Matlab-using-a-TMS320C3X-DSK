function varargout = Hanning_stop(varargin)


gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Hanning_stop_OpeningFcn, ...
                   'gui_OutputFcn',  @Hanning_stop_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function Hanning_stop_OpeningFcn(hObject, eventdata, handles, varargin)
handles.output = hObject;
guidata(hObject, handles);

function varargout = Hanning_stop_OutputFcn(hObject, eventdata, handles) 
...
wc1=(Fc1/(Fs/2));
wc2=(Fc2/(Fs/2));
b= fir1(N,[wc1 wc2],'stop',hanning(N+1));
w=0:0.01:pi;
H=freqz(b,1,w);
