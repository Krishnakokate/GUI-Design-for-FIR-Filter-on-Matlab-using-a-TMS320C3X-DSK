function varargout = Hamming_pass(varargin)


gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Hamming_pass_OpeningFcn, ...
                   'gui_OutputFcn',  @Hamming_pass_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function Hamming_pass_OpeningFcn(hObject, eventdata, handles, varargin)
handles.output = hObject;
guidata(hObject, handles);

function varargout = Hamming_pass_OutputFcn(hObject, eventdata, handles) 
...
wc1=(Fc1/(Fs/2));
wc2=(Fc2/(Fs/2));
b= fir1(N,[wc1 wc2],'bandpass',hamming(N+1));
w=0:0.01:pi;
H=freqz(b,1,w);
